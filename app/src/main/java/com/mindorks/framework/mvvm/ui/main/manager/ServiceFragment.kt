...
import com.mindorks.framework.mvvm.databinding.FragmentManagerDeviceBinding
...
class ServiceFragment : CommonFragment<FragmentManagerDeviceBinding, DetailModel>() {

    override val viewModel: DetailModel by viewModel()
    private val sharedViewModel by sharedViewModel<MainViewModel>()
    private var adapter : AccountAdapter? = null

    override fun getViewBinding(): FragmentManagerDeviceBinding = FragmentManagerDeviceBinding.inflate(layoutInflater)
